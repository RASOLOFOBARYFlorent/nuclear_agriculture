...
<body>
    <div class="links">
        ...
        <div class="right abovelinks" id="mainlinks">
            <ul>
                <li><a href="#" id="btncart" class="a"><img src="icones/cart2.svg" alt=""><h1 id="numbercart"><?=count(@$_SESSION['ids']);?></h1><span>Panier</span></a></li>
                <li><a href="#" id="btnnotification" class="a">
                    <p id="number"></p>
                ...
                <li><a href="#" id="btnprofile" class="a">
                    ...
                    <span>Profile</span>
                        <div class="profiles">
                            ...
                            <button href="deconnecer.php"id="deconnecter">Se deconnecter</button>
                        </div>
                </a>
            </li>
            </ul>
   ...
   <!-- end modification form of the clients -->
    ...
    <div class="containerservices">
        ...
        <div class="services">
            ...
            <script>
                   setTimeout(<?=$_SESSION['message'][1];?>,8000);
            </script>
    ...
    <!--end services -->
    <!-- commandes -->
    <div class="containercom" id="commande" style="display: none;">
    <?php
    //unset($_SESSION['ids']);
    if(isset($_GET['idservtocart'])){
        ...
        ?>
        <div class="commande" id="herecart">
            <img src="<?=$imgcart?>" alt="">
            <h1><?=$nameservicecart?></h1>
            <h2><?=$specificitycart?></h2>
            <p><?=$descriptionservicecart?>
            </p>
            <div class="priceandcart">
                <h1 id="price">
                    Total pour ce service <?=$pricecart?>€
                </h1>
                <a href="payer.php?idservpaid=<?=$idsaddtocart?>">Payer</a>
            </div>
        </div>
        <?php 
    }
    ...
    dec.onclick=()=>{
        window.location.href="deconexion.php";
    };
    });
